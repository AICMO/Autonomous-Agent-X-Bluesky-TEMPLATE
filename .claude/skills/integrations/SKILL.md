...
2. `process-outputs.yml` workflow runs on schedule
3. Calls platform integration script for each file
...
### Rate Limits
- **Premium tier:** API limits are higher, but workflow drain rate governs in practice
...
- Free tier limit: 17 tweets per 24-hour rolling window
